    ...
    <div class="container">
        <form action="<?= $GLOBALS['site_url'] ?>/save" method="POST">
            <div class="mb-3">
                ...
                <input type="text" name="title" class="form-control" style="font-size: 1.5rem;" id="title" placeholder="Title">
            </div>
            <div class="mb-3">
                <label for="task" class="form-label">Tasks</label>
                <textarea class="form-control" id="task" rows="10" style="font-size: 1.35rem;" name="task"></textarea>
            </div>
